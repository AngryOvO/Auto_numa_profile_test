...
def main():
    ...
    for node in all_nodes:
        ...
        if not same_source_df.empty:
            ...
            sns.heatmap(pivot_same, cmap=LinearSegmentedColormap.from_list("Thermal", ["navy", "red", "yellow"], N=256),
                        cbar=True)
        ...
        if not diff_source_df.empty:
            ...
            sns.heatmap(pivot_diff, cmap=LinearSegmentedColormap.from_list("Thermal", ["navy", "blue", "lightblue"], N=256),
                        cbar=True)
